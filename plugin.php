...
class WPCF7_Ava
{
    ...
    public function filters()
    {
        ...
        add_filter('wpcf7_pre_construct_contact_form_properties', array(&$this, 'pre_construct_contact_form_properties'), 10, 3);
    }
    ...
    public function pre_construct_contact_form_properties($properties)
    {
        $properties['ava'] = [];
        return $properties;
    }
...
?>
        <div id="wpcf7-ava-list">
            ...
            <div id="wpcf7-ava-items">
                ...
                <div class="mailtags"><small>
                        <pre>Form Fields: <?php echo implode(', ', (array)$post->collect_mail_tags()); ?></pre>
                    </small></div>
                <?php
                $i = 0;
            ...
            <script type="text/javascript">
                jQuery(document).ready(function() {
                    ...
                    jQuery(document).on('click', '#add-field-ava', function(event) {
                        ...
                        if (template) {
                            jQuery('#wpcf7-ava-items').append(template({
                                index: index
                            }));
                            index++;
                        }
